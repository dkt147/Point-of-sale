                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="from_date" name="to_date" placeholder="Purchase Date" class="form-control" value="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input id="to_date" name="to_date" placeholder="Return Date" class="form-control" value="">
                                        </div>
                                    </div>
                                </div>
                            </form>
