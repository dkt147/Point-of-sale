                ...
                <div class="content-box">
                    <div class="element-wrapper">
                        <div class="element-header">
                            ...
                            <input type="text" id="Category" name="BillSearch" placeholder="0000/1Ha" value="" class=" myInp">
                            <button class="btn btn-primary itemBtn">
                                <i class="fa fa-plus"> Add Sale Item</i>
                            </button>
                        </div>
                                ...
                                <table id="myTable">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>1600.00</td>
                                            <td>
                                                <a href="#" class="edit_item btn btn-success">
                        ...
                        <div class="element-box">
                            <div id="">
                                <div class="row">
                                    <div class="font-weight-bold col-sm-3 my-2">Total Amount:</div>
                                    <div class="col-sm-3 my-2" id="total_div">PKR 0</div>
                                    <div class="font-weight-bold col-sm-3 my-2">Total Items:</div>
                                    <div class="col-sm-3 my-2" id="totalItem_div">0</div>
                                </div>
                                <div class="row">
                                    <input hidden="" name="bill_dis" id="bill_dis" type="number" min="1">
                                    <div hidden="" id="total_bill_discount">0</div>
                                    <div class="font-weight-bold col-sm-3 my-2">Bill Discount:</div>
                                    <div class="col-sm-3 my-2" id="bill_discount">PKR 0</div>
                                    <div hidden="" id="total_item_discount">0</div>
                                    <div class="font-weight-bold col-sm-3 my-2">Total Items Discount:</div>
                                    <div class="col-sm-3 my-2" id="item_discount">PKR 0</div>
                                </div>
                                <div class="row">
                                    <div class="font-weight-bold col-sm-3 my-2">Total Tax:</div>
                                    <div class="col-sm-3 my-2" id="total_tax">PKR 0</div>
                                    <div hidden="" id="total_taxes">0</div>
                                    <div class="font-weight-bold col-sm-3 my-2">Total Payment:</div>
                                    <div class="col-sm-3 my-2" id="total_paym">PKR 0</div>
                                    <div class="font-weight-bold col-sm-3 my-2"><label for="remarks">Remarks:</label></div>
                                    <div class="col-sm-3 my-2" id="total_paym">
                                        <textarea name="remarks" id="remarks"></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-3 my-2">
                                        <button class="col-sm-12 btn btn-success" onclick="ask_payment_mode()" id="submit_payment">
                                            <i class="fa fa-money"></i> Return
                                        </button>
                                    </div>
                                    <div class="col-sm-3 my-2">
                                        <button class="col-sm-12 clear_sale btn btn-info" onclick="clear_this_sale()">
                                            <i class="fa fa-btn fa-trash"></i> Discard
                                        </button>
                                    </div>
                                </div>
                            </div> <!-- Calculation -->
                    ...
                    <div class="invoice-table">
                        ...
                        <div class="invoice-footer" style="margin-top:0;padding:0">
                            <div class="invoice-logo">
                                <img alt="" src="https://hnhresturant.cisepos.com/public/assets/img/logo-black.png"><br><span>Powered by CIS website:www.cisepos.com</span>
                            </div>
